                ...
                <div class="edit-pics">
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">Harshal Patil</a></h5>
                    ...
                    <div class="editor-pics">
                        <div class="col-md-3 item-pic">
                            <img src="image_uploads/f1.jpg" class="img-responsive" alt="">

                        </div>
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">Harshal Sonawane</a></h5>
                            <div class="td-post-date two"></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">Kapil Deore</a></h5>
                            <div class="td-post-date two"> </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
